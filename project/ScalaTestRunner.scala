...
object ScalaTestRunner {
  ...
  private def invokeScalaTestInSeparateProcess(scalaTestCommand: List[String],
  ...
  def runScalaTest(classpath: Classpath,
                   testClasses: File,
                   outfile: File,
  ...
  private def scalaTestCommand(testClasses: File,
                               outfile: File,
                               resourceFiles: List[File],
                               gradeOptions: Map[String, String],
  ...
  def scalaTestGrade(gradingReporter: GradingFeedback,
                     ...
                     resourceFiles: List[File],
                     gradeOptions: Map[String, String],
                     instragentPath: String): Unit = {

    val (score, maxScore, feedback, runLog) =
      runScalaTest(classpath,
                   testClasses,
                   outfile,
                   resourceFiles,
                   gradeOptions,
